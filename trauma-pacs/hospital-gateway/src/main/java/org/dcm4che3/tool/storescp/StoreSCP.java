 ...
 */
public class StoreSCP implements Runnable {
    ...
    private static LinkedBlockingDeque<File> files;
    ...
    public StoreSCP(String[] args, LinkedBlockingDeque files) {
        this.files = files;
        try {
            this.cl = parseComandLine(args);
    ...
    private StoreSCP() throws IOException {
    ...
    private void renameTo(Association as, File from, File dest, LinkedBlockingDeque files)
            throws IOException {
        ...
        try {
            ...
            LOG.error("Error occured in put file [{}] to queue!",dest);
        }
    }
